...
export default function HomePage() {
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden px-6">
      ...
      <div className="absolute left-1/2 top-0 h-[500px] w-[500px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-emerald-100/40 blur-3xl" />

      <div className="relative z-10 max-w-md text-center">
        <div className="mx-auto mb-8 flex h-24 w-24 items-center justify-center rounded-2xl bg-emerald-600 shadow-lg">
        ...
        <p className="mb-1 text-lg italic text-gray-400">
          scan · order · pay
        </p>
        ...
        <Link
          ...
          className="inline-block w-full rounded-xl bg-emerald-600 px-6 py-3.5 text-center font-medium text-white transition-all hover:bg-emerald-700 hover:shadow-lg active:scale-[0.98]"
        >
          View Demo Menu
        </Link>
